...
import { registerUser, loginUser ,loggedOut,refreshAccessToken,changePassword,deleteByEmail, findAllUser,sentResetCode,getUserDetails} from "../controllers/user.controller.js";
...
router.route("/register").post(
    ...
    router.get('/dashboard', verifyJwt,getUserDetails);
